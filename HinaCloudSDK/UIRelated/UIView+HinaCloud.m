...
static void *const kSAhinaDataIgnoreViewKey = (void *)&kSAhinaDataIgnoreViewKey;
...
- (BOOL)hinaDataIgnoreView {
    return [objc_getAssociatedObject(self, kSAhinaDataIgnoreViewKey) boolValue];
}

- (void)sethinaDataIgnoreView:(BOOL)hinaDataIgnoreView {
    objc_setAssociatedObject(self, kSAhinaDataIgnoreViewKey, [NSNumber numberWithBool:hinaDataIgnoreView], OBJC_ASSOCIATION_ASSIGN);
}
