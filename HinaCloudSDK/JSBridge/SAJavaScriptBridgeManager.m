...
#import "SAJSONUtil.h"
#import "SASwizzle.h"
#import "HinaCloudSDK+JavaScriptBridge.h"
...
- (void)setConfigOptions:(HNBuildOptions *)configOptions {
    ...
    self.enable = configOptions.enableJSBridge;
}

#pragma mark - SAJavaScriptBridgeModuleProtocol

- (NSString *)javaScriptSource {
    if (!self.configOptions.enableJSBridge) {
        return nil;
    }
...
- (void)userContentController:(WKUserContentController *)userContentController didReceiveScriptMessage:(WKScriptMessage *)message {
    ...
    @try {
        ...
        if ([callType isEqualToString:@"app_h5_track"]) {
            ...
            [[HinaCloudSDK sharedInstance] trackFromH5WithEvent:trackMessageString];
