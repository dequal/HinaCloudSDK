...
- (void)createSlinkWithCompletion:(void (^)(SASlinkResponse * _Nonnull))completion {
    ...
    //check custom domain
    NSString *customADChannelURL = HinaCloudSDK.sdkInstance.configOptions.customADChannelURL;
    ...
    //check project
    NSString *project = HinaCloudSDK.sdkInstance.network.project;
...
- (void)trackEventWithSlinkResponse:(SASlinkResponse *)response {
    ...
    [[HinaCloudSDK sharedInstance] track:kSADynamicSlinkEventName withProperties:[properties copy]];
}

- (NSDictionary *)buildSlinkParams {
    NSMutableDictionary *params = [NSMutableDictionary dictionary];
    params[kSADynamicSlinkParamProject] = HinaCloudSDK.sdkInstance.network.project;
