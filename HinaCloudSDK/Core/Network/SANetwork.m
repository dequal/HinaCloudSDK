...
- (NSURL *)serverURL {
    return [SAURLUtils buildServerURLWithURLString:HinaCloudSDK.sdkInstance.configOptions.serverURL debugMode:HinaCloudSDK.sdkInstance.configOptions.debugMode];
}
