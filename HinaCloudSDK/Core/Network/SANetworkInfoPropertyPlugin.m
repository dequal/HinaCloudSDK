...
/// 当前的网络类型
- (HNNetworkType)currentNetworkTypeOptions {
    ...
    if ([@"NULL" isEqualToString:networkTypeString]) {
        ...
        return HNNetworkTypeWIFI;
    }

    HNNetworkType networkType = HNNetworkTypeNONE;
#if TARGET_OS_IOS && !TARGET_OS_MACCATALYST
