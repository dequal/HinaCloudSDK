...
#ifndef HinaCloudSDK_Private_h
#define HinaCloudSDK_Private_h
...
@interface HinaCloudSDK(Private)
...
@property (nonatomic, strong, readonly) HNBuildOptions *configOptions;
