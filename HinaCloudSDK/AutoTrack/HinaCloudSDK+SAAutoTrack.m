...
@implementation HinaCloudSDK (SAAutoTrack)
...
- (void)disableViewType:(Class)aClass {
    [SAAutoTrackManager.defaultManager.appClickTracker disableViewType:aClass];
}
...
- (void)disableAutoTrackViewControllers:(NSArray<NSString *> *)controllers {
    [SAAutoTrackManager.defaultManager.appClickTracker disableAutoTrackViewControllers:controllers];
    [SAAutoTrackManager.defaultManager.appViewScreenTracker disableAutoTrackViewControllers:controllers];
}
