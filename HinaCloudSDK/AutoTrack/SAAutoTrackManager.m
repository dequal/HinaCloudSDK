...
- (BOOL)isAutoTrackEnabled {
    ...
    if (autoTrackMode == kSAAutoTrackModeDefault) {
        ...
        return (self.configOptions.autoTrackEventType != HNAutoTrackNone);
    } else {
...
- (void)updateAutoTrackEventType {
    self.appStartTracker.ignored = [self isAutoTrackEventTypeIgnored:HNAutoTrackAppStart];
    self.appEndTracker.ignored = [self isAutoTrackEventTypeIgnored:HNAutoTrackAppEnd];
    self.appViewScreenTracker.ignored = [self isAutoTrackEventTypeIgnored:HNAutoTrackAppScreen];
    self.appClickTracker.ignored = [self isAutoTrackEventTypeIgnored:HNAutoTrackAppClick];
}
...
- (void)registerPlugins {
    BOOL enableAppClick = self.configOptions.autoTrackEventType & HNAutoTrackAppClick;
    if (!enableAppClick) {
        return;
    }
