...
#import "SALog.h"
#import "HNBuildOptions+Exception.h"
...
- (void)handleUncaughtException:(NSException *)exception {
    ...
    @try {
        ...
        [HinaCloudSDK.sharedInstance trackEventObject:object properties:properties];
        ...
        sensorsdata_dispatch_safe_sync(HinaCloudSDK.sdkInstance.serialQueue, ^{});
