...
static void sa_tablViewDidSelectRowAtIndexPath(id self, SEL _cmd, id tableView, id indexPath) {
    ...
    [HNAutoTrackManager.defaultManager.appClickTracker autoTrackEventWithScrollView:tableView atIndexPath:indexPath];
}
...
static void sa_collectionViewDidSelectItemAtIndexPath(id self, SEL _cmd, id collectionView, id indexPath) {
    ...
    [HNAutoTrackManager.defaultManager.appClickTracker autoTrackEventWithScrollView:collectionView atIndexPath:indexPath];
}

@implementation HNCellClickHookDelegatePlugin
