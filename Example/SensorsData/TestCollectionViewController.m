...
@interface TestCollectionViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,UICollectionViewDelegateFlowLayout,HNUIViewAutoTrackDelegate>
...
- (void)viewDidLoad {
    ...
    self.collectionView.hinaDataDelegate = self;
