...
#if __has_include("HinaDataSDK+WKWebView.h")
#error This file cannot exist at the same time with `HinaDataSDK+WKWebView.h`. If you use `UIWebView`, please delete it.
#endif

#import "HinaDataSDK+WebView.h"
