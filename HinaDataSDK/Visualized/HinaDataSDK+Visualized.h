...
@interface HinaDataSDK (Visualized)
...
/**
 指定哪些页面开启 可视化全埋点 分析，
 如果指定了页面，只有这些页面的 H_AppClick 事件会采集控件的 viewPath。
...
/**
 ...
 只有这些页面的 H_AppClick 事件会采集控件的 viewPath
...
@interface HNConfigOptions (Visualized)
