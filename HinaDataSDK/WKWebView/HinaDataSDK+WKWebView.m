...
#if __has_include("HinaDataSDK+WebView.h")
#error This file cannot exist at the same time with `HinaDataSDK+WebView.h`. If you usen't `UIWebView`, please delete it.
#endif

#import "HinaDataSDK+WKWebView.h"
