...
@interface HinaDataSDK (HNAutoTrack)
 ...
 *
 * @param eventType HinaDataAutoTrackEventType 要判断的 AutoTrack 事件类型
 *
 ...
 *   https://hinadata.cn/manual/ios_sdk.html
 * 该功能默认关闭
 */
- (void)enableAutoTrack:(HinaDataAutoTrackEventType)eventType __attribute__((deprecated("已过时，请参考 HNConfigOptions 类的 autoTrackEventType")));

@end

@interface HNConfigOptions (AutoTrack)
 ...
 * 该功能默认关闭
 */
@property (nonatomic) HinaDataAutoTrackEventType autoTrackEventType API_UNAVAILABLE(macos);
