...
@interface HinaDataSDK (HNChannelMatch)
 ...
 *
 * @discussion
 * 这个接口是一个较为复杂的功能，请在使用前先阅读相关说明: https://hinadata.cn/manual/track_installation.html，并在必要时联系我们的技术支持人员。
 *
 * @param event             event 的名称
 */
...
@interface HNConfigOptions (ChannelMatch)
