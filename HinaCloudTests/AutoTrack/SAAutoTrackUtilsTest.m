...
- (void)testViewTypeIgnoredOfSubClass {
    [[HinaCloudSDK sharedInstance] disableViewType:[UIControl class]];
    BOOL buttonIgnored = [[HinaCloudSDK sharedInstance] isViewTypeIgnored:[UIButton class]];
    XCTAssertTrue(buttonIgnored);

    BOOL segmentedControlIgnored = [[HinaCloudSDK sharedInstance] isViewTypeIgnored:[UISegmentedControl class]];
    XCTAssertTrue(segmentedControlIgnored);
}

- (void)testViewTypeIgnoredOfCurrentClass {
    [[HinaCloudSDK sharedInstance] disableViewType:[UIControl class]];
    BOOL controlIgnored = [[HinaCloudSDK sharedInstance] isViewTypeIgnored:[UIControl class]];
    XCTAssertTrue(controlIgnored);
}

- (void)testViewTypeIgnoredOfSuperClass {
    [[HinaCloudSDK sharedInstance] disableViewType:[UIControl class]];
    BOOL viewIgnored = [[HinaCloudSDK sharedInstance] isViewTypeIgnored:[UIView class]];
    XCTAssertFalse(viewIgnored);
}

- (void)testViewTypeIgnoredOfOtherClass {
    [[HinaCloudSDK sharedInstance] disableViewType:[UIControl class]];
    BOOL itemIgnored = [[HinaCloudSDK sharedInstance] isViewTypeIgnored:[UIBarButtonItem class]];
